                ...
                <>
                  ...
                  <p className="text-xs text-gray-400 mt-3 text-center">
                    {(() => {
                      ...
                      if (earlyPct > 40) return `⚠️ ${earlyPct}% das chamadas atendidas duram menos de 30s — sinal de script fraco ou abordagem incorreta.`;
                      if (earlyPct > 20) return `${earlyPct}% das chamadas atendidas encerram antes de 30s — avalie a abertura do script.`;
